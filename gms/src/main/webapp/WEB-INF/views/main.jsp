			      ...
			      <nav id="nav-menu-container">
			        <ul class="nav-menu">
			          ...
			          <li class="menu-has-children"><a href="">Member</a>
			            <ul>
			              <li><a href="blog-home.html" id="login_btn">Login</a></li>
			              <li><a href="blog-single.html">My page</a></li>
			            </ul>
			          </li>	
				...
				<div class="container">
					<div class="row fullscreen align-items-center justify-content-between">
						<div class="col-lg-6 col-md-6 banner-left">
							...
							<p>
								This is my effort to practice how to make web site using JAVA,SQL,JS,HTML and CSS etc.
							</p>
